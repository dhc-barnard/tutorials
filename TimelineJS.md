...
-   Understand how chronological information, text and media  can come together to create an engaging narrative
-   Create your own sample TimelineJS, using Google sheets and TimelineJS
...
-   **Date cells:** The first group of cells ask for start, end, and display dates. Because this is the title slide, these cells have been left blank. We'll leave them that way.![Date cells with labels](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/5-timeline.png)
-   **Text cells:** These are simple, just **replace the sample "headline" and "text" cells with your own copy. **![headline and text cells with content about Barnard Greek games](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/6-timeline.png)
-   **Media cells: **These cells refer to the media - image, video, Twitter post, etc. on your slide.  You can  view [a list of all media types TimelineJS accepts.](https://timeline.knightlab.com/docs/media-types.html) ![Sample media cells](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/7-timeline.png)
...
-   **Additional Cells: **The last three cells give additional options for customization. We've already added the "type" information, and the "group" cell is only relevant for events slides. The background cell lets you change your slides background - you can use an image file, a [CSS color name](https://www.w3schools.com/cssref/css_colors.asp), or a [hex code](https://www.hexcolortool.com/).![title, group and background cells](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/8-timeline.png)
...
![Date information cells: start year, month, date and time; end year, month, date and time; display date](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/9-timeline.png)
...
![slide where date range appears on the top and the bottom](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/10-daterangexample.png)
...
![date cells with year as "1903" and display date as "Spring 1903"](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/11-timeline.png)
...
![step2 from Timeline instructions - visit Timeline website for accessible version](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/16-step2.png)

![step3 from Timeline instructions - visit Timeline website for accessible version](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/17-step3.png)

![step 4 from Timeline instructions - visit Timeline website for accessible version](https://github.com/dhc-barnard/tutorials/blob/master/images/TimelineJS/18-step4.png)
