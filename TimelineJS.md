...
-   **Additional Cells:** The last three cells give additional options for customization. We've already added the "type" information, and the "group" cell is only relevant for events slides. The background cell lets you change your slides background - you can use an image file, a [CSS color name](https://www.w3schools.com/cssref/css_colors.asp), or a [hex code](https://www.hexcolortool.com/). <img src="/images/TimelineJS/8-timeline.png" width="20%" alt="title, group and background cells">
...
In addition to the examples shown in the Guided Practice section:
...
## Syallabi/Assignment using this tool:
...
## Barnard Resources:
- Please reach out to the [DHC](digitalhumanities.barnard.edu) or [IMATS](https://imats.barnard.edu/) if you need additional help with TimelineJS! 
